...
Field names are camelCase to match the JSON the frontend sends
(see Frontend/src/lib/api.ts).  Pydantic's ``alias_generator`` handles
the Python ↔ JSON translation automatically.
"""
