...
export default function WhatsAppPreviewBubble({
  ...
  return (
    <div className="flex items-start justify-center rounded-2xl bg-[#e5ddd5] p-5">
      <div className="w-full max-w-[260px] overflow-hidden rounded-2xl rounded-tl-sm bg-surface shadow-sm">
        ...
        <div className="flex flex-col divide-y divide-ink/[.06] border-t border-ink/[.06]">
          {kind === "buttons" ? (
            buttons.map((b) => (
