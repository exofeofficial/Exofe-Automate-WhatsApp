    ...
    <div className="rounded-2xl border border-black/[.06] bg-white p-5 shadow-sm sm:p-6">
      ...
      <div className="mt-5 flex items-center gap-3">
        <button
          ...
          onClick={onSave}
          disabled={saving}
          className="flex items-center gap-2 rounded-xl bg-gradient-to-br from-[#5B4FE9] to-[#7C6FF5] px-5 py-2.5 text-xs font-semibold text-white shadow-sm hover:opacity-90 disabled:opacity-70"
        >
