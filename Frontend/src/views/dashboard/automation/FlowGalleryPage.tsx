    ...
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <Link
          ...
          className="flex shrink-0 items-center gap-1.5 rounded-xl shine-btn-gold relative overflow-hidden bg-gradient-to-br from-[#5B4FE9] to-[#7C6FF5] px-4 py-2.5 text-xs font-semibold text-white shadow-sm hover:opacity-90"
        >
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <Link
          ...
          className="group flex flex-col rounded-2xl border border-ink/[.06] bg-surface p-5 shadow-sm transition-colors hover:border-[#5B4FE9]/30"
        >
          ...
          <p className="mt-4 border-t border-ink/[.06] pt-3 text-xs font-semibold text-[#5B4FE9] group-hover:underline">
            View flow →
          </p>
        </Link>
        ...
        {loading && (
          <div className="flex items-center justify-center rounded-2xl border border-ink/[.06] bg-surface p-5 shadow-sm">
            <Loader2 className="h-5 w-5 animate-spin text-[#5B4FE9]" strokeWidth={2} />
          </div>
        )}
