      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 rounded-full shine-btn-gold relative overflow-hidden bg-[#45157b] px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-colors hover:opacity-90"
          >
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-50 dark:bg-indigo-500/15 text-[#45157b]">
                ...
                <div className="mt-4 flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="flex flex-1 items-center justify-center gap-1.5 rounded-full shine-btn-gold relative overflow-hidden bg-[#45157b] py-2 text-xs font-semibold text-white transition-colors hover:opacity-90 disabled:opacity-50"
                  >
                    {isActivating ? (
            ...
            >
              ...
              <div className="p-5">
                ...
                <button
                  ...
                  className="mt-5 flex w-full items-center justify-center gap-2 rounded-full shine-btn-gold relative overflow-hidden bg-[#45157b] py-3 text-sm font-semibold text-white shadow-sm transition-colors hover:opacity-90 disabled:opacity-50"
                >
